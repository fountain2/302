...
<div class="top">
	...
	<div class="menu">
		<c:if test="${empty user}">
			...
			<a class="menu-link" href="#">学生信息一览</a>|
			<a class="menu-link" href="#">学生课程成绩管理</a>|
			<!--<a class="menu-link" href="#">学生成绩一览表</a>|-->
			<a class="menu-link" href="#">学生成绩一览</a>
		</c:if>
		<c:if test="${not empty user}">
			<a class="menu-link" href="login.do">首页</a>|
			...
			<a class="menu-link" href="studentSearchall.do">学生信息一览</a>|
			<c:if test="${not empty isAdmin && isAdmin}">
				<a class="menu-link" href="gradeAdmin.do">学生课程成绩管理</a>|
			</c:if>
			<!--  <a class="menu-link" href="gradeList.do">学生成绩一览表</a>|-->
			<a class="menu-link" href="gradeSearch.do">学生成绩一览</a>|
